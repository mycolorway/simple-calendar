...
Calendar = (function(_super) {
  ...
  Calendar.prototype._init = function() {
    ...
    this.month = moment(this.opts.month, 'YYYY-MM');
  ...
  Calendar.prototype._render = function() {
    var i, _i;
    this.el.addClass('simple-calendar').data('calendar', this);
  ...
  Calendar.prototype.addEvent = function(events) {
    var $event, $eventList, $events, event, eventsAcrossDay, eventsInDay, list, reorderList, results, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref;
    if (!$.isArray(events)) {
      events = [events];
    }
    eventsAcrossDay = [];
