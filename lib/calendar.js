...
Calendar = (function(superClass) {
  ...
  Calendar.prototype._DiffDay = function(end, start) {
    var endDate, j, m, ref, ref1, tmpDate;
    tmpDate = start.clone();
    endDate = end.date();
    if (start.month() < end.month()) {
      for (m = j = ref = start.month(), ref1 = end.month() - 1; ref <= ref1 ? j <= ref1 : j >= ref1; m = ref <= ref1 ? ++j : --j) {
  ...
  Calendar.prototype._renderEventAcrossDay = function(event) {
    var $day, $event, $spacer, $spacerList, $spacers, $week, date, dayCount, days, events, i, j, k, l, len, len1, n, occupied, ref, ref1, rows, slot, week;
    ...
    for (week in rows) {
      ...
      for (l = 0, len1 = days.length; l < len1; l++) {
        ...
        if (slot < $spacers.length) {
          ...
          for (i = n = 0, ref1 = slot - $spacers.length; 0 <= ref1 ? n <= ref1 : n >= ref1; i = 0 <= ref1 ? ++n : --n) {
